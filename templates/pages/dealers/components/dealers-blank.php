<section class="dealers-blank" id="dealers-blank">
	<div class="container">
		<div class="row">
			<div class="col-xl-12">
				<div class="brick"></div>
		...
		<div class="row">
			<div class="col-xl-5 col-12 col-md-5 col-lg-5 d-flex align-items-center">
				<div class="dealers-blank-offer">
					...
					<p class="desc-section">
						отправьте заявку в форме фирменного бланка на нашу
			...
			<div class="col-xl-7 col-12 col-md-7 col-lg-7 d-flex justify-content-end">
