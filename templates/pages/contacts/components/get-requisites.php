    ...
    <div class="container">
        <div class="row flex-column-reverse flex-md-row">
            <div class="col-xl-7 col-md-7 col-lg-7 d-flex align-items-center">
                <div class="get-requisites-offer wow fadeInLeft">
            ...
            <div class="col-xl-5 col-md-5 col-lg-5">
                <div style="background: url('<?php echo get_template_directory_uri() . '/assets/dist/img/components/requisites/file.png' ?>') no-repeat" class="get-requisites-img wow fadeInRight"></div>
            </div>
        </div>
    </div>
