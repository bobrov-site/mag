	...
	<div class="container">
		<div class="row">
			<div class="col-xl-7 col-md-7">
				<img class="our-products-action-img lazyload wow fadeInLeft" data-src="<?php echo get_the_post_thumbnail_url('', 'hd') ?>" alt="<?php echo $image_title ?>">
			</div>
			<div class="col-xl-5 col-md-5 d-flex align-items-center">
				<div class="our-products-action-offer wow fadeInRight">
