        ...
        <div class="row flex-column-reverse flex-md-row">
            <div class="col-xl-6 col-md-6">
                ...
                <div class="partners-offer">
                    <img class="partners-offer-img" src="<?php echo get_the_post_thumbnail_url('', array(630, 240)) ?>" alt="<?php echo $image_title ?>">
                    ...
                    <div class="partners-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                ?>
                                <img class="partners-logo" src="<?php echo get_the_post_thumbnail_url('', 'logo-slider') ?>" alt="<?php echo $image_title ?>">
                            </div>
		                        <?php wp_reset_postdata(); ?>
	                        <?php endwhile; ?>
                        </div>
